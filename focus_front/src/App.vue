...
<template>
  <div class="relative h-full overflow-hidden bg-background">
    ...
    <button type="button"
      ...
      :class="collapsed ? 'left-6' : 'left-66'" :aria-expanded="!collapsed" aria-label="Hide or show the menu"
      @click="collapsed = !collapsed">
      <!-- Sidebar toggle icon -->
      <svg class="size-4.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"
    ...
    <!-- Views -->
    <main class="h-full transition-[padding-left] duration-150 ease-in-out motion-reduce:transition-none"
