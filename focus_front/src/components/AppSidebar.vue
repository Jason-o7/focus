...
<template>
  ...
  >
    <!-- Sidebar - Brand -->
    <h1
      class="absolute top-7 left-8 m-0 flex items-center gap-3 text-title font-bold tracking-tight"
    >
      <span
        class="size-10 shrink-0 rounded-[10px] border border-dashed border-border"
        aria-hidden="true"
      />
      Focus
    </h1>
